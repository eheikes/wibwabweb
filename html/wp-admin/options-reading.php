...
<!-- The check boxes default to "static page" and are then hidden. per #1290. lukef@AQ 10/20/09 -->
        <p class="hidden"><label>
		<input name="show_on_front" type="radio" value="posts" class="tog" <?php checked('posts', 'page'); ?> />
	...
	<p class="hidden"><label>
        ...
        <p><?php print(wp_dropdown_pages("name=page_on_front&echo=0&show_option_none=".__('- Select -')."&selected=" . get_option('page_on_front'))); ?></p>
<!-- lukef@AQ #1290
<ul>
...
<?php endif; ?>
<!-- Hide blog pages show setting. per #1290. lukef@AQ 10/01/09 -->
