...
// __TODO__ Modify this for WibWabWeb. --Eric@AQ
function wp_dashboard_right_now() {
	...
	// Posts
	/* Posts not used in WibWabWeb --Eric@AQ
	...
	*/
	...
	// Total Comments
	/* Comments not used in WibWabWeb --Eric@AQ
	...
	*/
	...
	// __TODO__ Put something here -- public pages or pages in navigation --Eric@AQ
	echo '<td class="b b_approved">&nbsp</td>';
...
function wp_welcome_panel() {
	...
	<div class="wp-badge"><?php //printf( __( 'Version %s' ), $display_version ); // don't overlay version --Eric@AQ ?></div>
	...
	<div class="welcome-panel-column">
		...
		<ul>
		<?php // swapped these first two LIs --Eric@AQ ?>
	...
	<div class="welcome-panel-column welcome-panel-last">
		...
		if ( empty ( $ct->stylesheet_dir ) ) :
			...
			if ( false/*current_theme_supports( 'widgets' )*/ ) // don't mention widgets --Eric@AQ
