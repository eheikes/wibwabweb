...
<?php
	...
	//#1290 lukef@AQ
	echo "\t" . __('<a href="http://codex.wordpress.org/Formatting_Date_and_Time">Documentation on date and time formatting</a>.') . "\n";
?>
	</fieldset>
</td>
</tr>
...
<?php
	...
	// Never show language option. We want to use the "aq-wibwabweb" language. --Eric@AQ
	/*
