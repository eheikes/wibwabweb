...
<?php   }
	...
	// Add bookmark reminder for users. --Eric@AQ
	if ($title == "Log In"
	and (!isset($_COOKIE['bookmark-reminder'])
	     or $_COOKIE['bookmark-reminder'] != 0)):
?>
...
//<![CDATA[
	...
	{
		// Add the message box.
		$("<div id='bookmark-reminder' class='message'>\
This is the login page to your site&#8217;s control panel. \
You should <a rel='sidebar' id='bookmark' href='#'>bookmark it<\/a> for future reference. \
<div><a id='hide-bookmark-reminder' href='#'>Don&#8217;t show this again<\/a>.<\/div>\
<\/div>").prependTo("body");
		
		// Add the bookmark link.
		$("#bookmark").click(function(event) {
			// __TODO__ This function hasn't been tested fully across browsers.
			...
			{
				alert("We're sorry, but we were unable to add the bookmark."
		...
		// Add the bookmark reminder link.
		$("#hide-bookmark-reminder").click(function(event) {
			$.cookie('bookmark-reminder', '0', { expires: 365*20 });
			$("#bookmark-reminder").fadeOut('slow');
...
<?php endif; // end bookmark reminder
