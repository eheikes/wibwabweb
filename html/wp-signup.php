...
function wpmu_signup_stylesheet() {
	// tweaked CSS a bit --Eric@AQ
	?>
	<style type="text/css">
		.mu_register form { margin-top: 2em; }
		.mu_register .error { font-weight:700; padding:10px; color:#333333; background:#FFEBE8; border:1px solid #CC0000; margin-bottom:0; }
		.mu_register input[type="submit"],
		.mu_register #blog_title,
		.mu_register #user_email,
		.mu_register #blogname,
		.mu_register #user_name { width:100%; font-size: 24px; margin:5px 0; }
		.mu_register #blogname { width:70%; }
		.mu_register .prefix_address,
		.mu_register .suffix_address {font-size: 18px;display:inline; }
		.mu_register label { font-weight:700; font-size:15px; display:block; margin:20px 0 0; }
...
function show_blog_form($blogname = '', $blog_title = '', $errors = '') {
	...
	<div id="privacy">
		<?php // always default to public sites --Eric@AQ ?>
...
function signup_user($user_name = '', $user_email = '', $errors = '') {
	...
	<?php // Added these paragraphs --Eric@AQ ?>
	<p>Want to get started? Sign up for a trial account
	and create and preview your site instantly!</p>
	<p>(If you already have an account with us, please
	<a href="wp-login.php?redirect_to=wp-signup.php">log in</a> to add another site.)</p>
	<form id="setupform" method="post" action="wp-signup.php">
		...
		<p>
		<?php // Should always be for a new "blog" (site) --Eric@AQ ?>
...
function confirm_blog_signup($domain, $path, $blog_title, $user_name = '', $user_email = '', $meta) {
	...
	<p>
		...
		<ul id="noemail-tips">
			...
			<?php // Added option of contacting support --Eric@AQ ?>
			<li><?php _e( 'Still having trouble signing up? <a href="http://wibwabweb.com/contact/">Contact our support team for further assistance.</a>' ) ?></li>
		</ul>
	</p>
	<?php
	do_action( 'signup_finished' );
