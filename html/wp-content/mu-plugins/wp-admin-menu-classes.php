...
By Mike Schinkel (https://gist.github.com/792b7aa5b695d1092520)
...
class WP_AdminMenuItem {
	...
	function set_title($new_title) {
		...
		// Also change the page title. --Eric@AQ
		if (isset($GLOBALS['submenu'][$this->parent_slug][$this->index][3])) {
			$GLOBALS['submenu'][$this->parent_slug][$this->index][3] = $new_title;
		}
	}
	function get_capability() {
