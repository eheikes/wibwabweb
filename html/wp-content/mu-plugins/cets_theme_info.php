...
function theme_info_page(){
   ...
   <?php
	...
	// Replace WP_CONTENT_URL with the new SSL-aware function. --Eric@AQ
	$file = content_url('/mu-plugins/cets_theme_info/lib/tablesort.js');
	?>
	...
	foreach ($list as $theme => $blogs){
		...
		$thisTheme = @$themes[$theme]; // suppress errors if the theme header is malformed --Eric@AQ
