...
function rw_cryptx_submenu() {
	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<?php // fix prefilling of values (see http://weber-nrw.de/wordpress/cryptx/#comment-3485) --Eric@AQ ?>
			<td><input name="cryptX_var[java]" <?php echo (@$cryptX_var['java'] == true) ? 'checked="checked"' : ''; ?> type="radio" value="1" />&nbsp;&nbsp;<?php _e("Use javascript to hide the Email-Link.",'cryptx'); ?><br/>
				<input name="cryptX_var[java]" <?php echo (@$cryptX_var['java'] != true) ? 'checked="checked"' : ''; ?> type="radio" value="0" />&nbsp;&nbsp;<?php _e("Use Unicode to hide the Email-Link.",'cryptx'); ?></td>
		</tr>
		<tr valign="top">
			<th scope="row"><?php _e("Where to load the needed javascript...",'cryptx'); ?></th>
			<?php // fix prefilling of values (see http://weber-nrw.de/wordpress/cryptx/#comment-3485) --Eric@AQ ?>
			<td><input name="cryptX_var[load_java]" <?php echo (@$cryptX_var['load_java'] != true) ? 'checked="checked"' : ''; ?> type="radio" value="0" />&nbsp;&nbsp;<?php _e("Load the javascript in the <b>header</b> of the page.",'cryptx'); ?><br/>
				<input name="cryptX_var[load_java]" <?php echo (@$cryptX_var['load_java'] == true) ? 'checked="checked"' : ''; ?> type="radio" value="1" />&nbsp;&nbsp;<?php _e("Load the javascript in the <b>footer</b> of the page.",'cryptx'); ?></td>
		</tr>
		<tr valign="top">
